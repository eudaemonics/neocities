...
title: bookmarks
description: Interesting websites and resources
...
-   [Noob-friendly guide for migrating from Zoner to Eleventy](https://renkotsuban.com/posts/2025-07-25-Updates-to-the-Eleventy-guide.html) by Renkon
    - This is how I run my site and probably will forever. (Probably)
...
-   [Free CSS Layouts](https://www.free-css.com/)
-   [Transparenttextures.com](https://www.transparenttextures.com/)
-   [html.earth](https://html.earth/) - A tiny site generator with a built in front matter editor that converts markdown input into HTML.
-   [Markdown2HTML](https://markdowntohtml.com/)
-   [Static ultra](https://scott2.neocities.org/projects/static-ultra/) - A static site generator to streamline the process of creating and updating your site
-   [Zoner](https://ryantrawick.itch.io/zoner) - A static site generator for Zonelets-style blogs.
-   [HTML Comment Box](https://www.htmlcommentbox.com/)
-   [Lorem Ipsum generator](https://loremipsum.io/)
-   [soupalt.app](https://soupault.app/) - A static website generator/framework.
...
If any of these links are broken, send me a message on my neocities profile.